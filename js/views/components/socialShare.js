...
define([
  ...
  'backbone'
        ...
        '<div>' +
        '<ul class="nav">' +
        '<li><a href="https://twitter.com/share?url=<%= encodeURIComponent(readUrl) %>&text=<%= encodeURIComponent(name) %> - <%= encodeURIComponent(message) %>" target="_blank" id="TwitterButton"><i class="fa fa-twitter"></i></a></li>'+
        ...
        '<li><a href="javascript:void(0);" id="FacebookButton"><i class="fa fa-facebook"></i></a></li>' +
        '</ul>' +
        '</div>' +
        '</div>',
        initialize: function(){
