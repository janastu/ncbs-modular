...
var images = new Images([
	{type: "image", src: "1960s-70s-Stahl-and-OS-awards-ceremonial.png", caption: "In the late 1960s, Frank Stahl (right), a renowned biologist, came for a workshop to TIFR. Here, he participates (in ceremonial attire, a one-time event) in an awards function for those who attended a course in phage genetics. This image is part of the exhibit's Sandbox Ephemera theme -- every screen refresh brings up a different image from across the history of NCBS, TIFR and their connected communities. <em>TIFR Archives</em>."},
	{type: "image", src: "1990-92-Bangalore-Land-File-Log-Book-1.jpg", caption : "File 181 in TIFR is synonymous with all things related to the TIFR Centre. People would check the logbook in and out, and it got especially busy in the years between 1990 and 1992. This image is part of the exhibit's Sandbox Ephemera theme -- every screen refresh brings up a different image from across the history of NCBS, TIFR and their connected communities. <em>Records office,TIFR</em>."},
	{type: "image", src: "1981-Ajith-macaque-fieldwork-braille-5a.jpg", caption: "Ajith Kumar's field notes from 1982-83, written on Braille paper (sourced from a church in the US, since resources were limited, and it was good non-blotting paper). The notes are for studies on how four species of tree living mammals co-exist and compete for same resources in the Anamalai Hills, Tamil Nadu. This image is part of the exhibit's Sandbox Ephemera theme -- every screen refresh brings up a different image from across the history of NCBS, TIFR and their connected communities. <em>Courtesy of Ajith Kumar</em>."},
