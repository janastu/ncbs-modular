...
var images = new Images([
	{type: "image", src: "1960s-70s-Stahl-and-OS-awards-ceremonial.png", caption: "In the late 1960s, Frank Stahl (right), a renowned biologist, came for a workshop to TIFR. Here, he participates (in ceremonial attire, a one-time event) in an awards function for those who attended a course in phage genetics."},
	...
	{type: "image", src: "2016-TIFR-bird-graffiti.JPG", caption: "This image is part of the exhibit's Sandbox Ephemera theme -- every screen refresh brings up a different image from across the history of NCBS, TIFR and their connected communities."},
